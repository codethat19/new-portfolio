...
export const personalInfo = {
	...
	bio: "Frontend Engineer with 4+ years of experience building scalable, high-performance web applications using React.js and Next.js. Proven track record of improving frontend performance by up to 40%, building reusable component libraries, and delivering production-grade applications used by 100k+ users. Specialized in modern frontend architecture, performance optimization, and creating intuitive user experiences.",
